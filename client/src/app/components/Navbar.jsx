...
<div className="block lg:hidden relative z-20">
  ...
  >
    <div className="w-10 h-10 rounded-full bg-[#467B23] text-white flex items-center justify-center font-semibold text-lg uppercase shadow-sm hover:scale-105 transition-transform duration-200">
      {userInitial}
    </div>
  </Link>
): (
    ...
    >
      ...
      <span className="relative z-10 font-['Poppins'] text-sm">
        Log In
      </span>
    </button>
  )}
...
>
  ...
  {authLoading ? (
    ...
    <Link  href="/user" className="flex items-center gap-3">
      <div className="w-10 h-10 rounded-full bg-[#467B23] text-white flex items-center justify-center font-semibold text-lg uppercase">
        {userInitial}
      </div>

      <span className="text-[#01193B] font-medium">
        {userName}
      </span>
    </Link>
  ) : (
      ...
      <span className="absolute top-0 right-0 w-12 h-full -mr-3 pointer-events-none">
        ...
        >
          <path
            ...
            fillRule="nonzero"
            fill="#FFF"
            d="M487 486.7c-66.1-3.6-132.3-7.3-186.3-37s-95.9-85.3-126.2-137.2c-30.4-51.8-49.3-99.9-76.5-151.4C70.9 109.9 35.6 54.8.3 0H487v486.7z"
          />
        </svg>
      </span>
