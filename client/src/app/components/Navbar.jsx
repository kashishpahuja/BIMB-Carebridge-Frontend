...
<div className="bg-[#0b2345] text-white overflow-hidden">
  ...
  >
    ...
    <div className="relative w-full z-99999 backdrop-blur-md px-5
      md:px-12
      lg:px-24
      xl:px-40 ">
        ...
        >
          <div className="w-full h-auto  overflow-hidden">
            <Image
              ...
              alt="logo"
              className="w-[230px]  h-full xl:w-full xl:h-auto object-contain"
            />
          </div>
        </Link>
...
<div className="hidden lg:block relative z-20">
  ...
  >
   ...
   Log In
      ...
      {/* <ul
        ref={dropdownRef}
        className={`poppins xl:hidden flex flex-col 0 bg-white/95 backdrop-blur-sm border border-[#467B23]/30 text-[#01193B] shadow-xl mx-4 md:mx-8  rounded-xl px-4 py-6 text-center text-md font-medium 
