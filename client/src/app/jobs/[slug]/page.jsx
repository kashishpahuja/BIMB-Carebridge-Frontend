...
export default function JobDetailPage() {
  ...
  useEffect(() => {
    ...
    // Find the matching job by comparing the exact slug field from the updated schema/sample data
  ...
  // Extract other latest jobs from the same category or company for the sidebar widget
  const latestJobs = useMemo(() => {
    ...
    return (jobData.jobs || [])
      .filter(
        (j) =>
          j.slug !== job.slug &&
          (j.category === job.category || j.companyName === job.companyName),
      )
      .slice(0, 5);
  }, [job]);
  ...
  const locationText = typeof job.location === 'object' && job.location !== null
    ? [job.location.city, job.location.state, job.location.country].filter(Boolean).join(', ')
    : job.location;

  // Format salary from object
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 items-start">
          ...
          <div className="lg:col-span-2 space-y-6 sm:space-y-8">
            ...
            {job.skills && job.skills.length > 0 && (
              <div className="space-y-4 sm:space-y-6">
                <h3 className="text-lg sm:text-xl font-medium text-[#01193B] border-b border-[#01193B]/10 pb-4">
                  Required <span className="font-semibold text-[#467B23]">Skills</span>
                </h3>
                <div className="flex flex-wrap gap-2">
                  {job.skills.map((skill, idx) => (
                    <span
                      key={idx}
                      className="bg-[#01193B]/5 text-[#01193B] px-3.5 py-1.5 text-xs font-medium rounded-xl border border-[#01193B]/10"
                    >
                      {skill}
                    </span>
                  ))}
              ...
              <div className="flex items-center gap-4">
                {job.companyLogo ? (
                  <img
                    src={job.companyLogo}
                    alt={job.companyName}
                    className="w-12 h-12 rounded-2xl object-cover bg-[#467B23]/10"
                  />
                ) : (
                ...
                <div>
                  ...
                  {job.companyWebsite && (
                    ...
                    >
                      <Globe size={13} /> {job.companyWebsite}
                    </a>
                  )}
                </div>
              </div>
              <p className="text-sm text-[#01193B]/70 font-light leading-relaxed">
                Committed to delivering professional solutions, ensuring top-tier working environments, competitive compensation structures, and dependable opportunities across all operational divisions.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6 lg:sticky lg:top-28">
            ...
            <div className="bg-white border border-[#01193B]/10 p-5 sm:p-6 lg:p-8 shadow-sm rounded-3xl space-y-6">
              ...
              <div className="space-y-4 text-sm">
                ...
                <div className="flex items-center justify-between py-2 border-b border-gray-100 gap-2">
                  <span className="text-[#01193B]/50 flex items-center gap-2">
                    <Award size={16} className="text-[#467B23]" /> Work Mode
                  </span>
                  <span className="font-semibold text-[#01193B] text-right">
                    {job.workMode}
                  </span>
                ...
                <div className="flex items-center justify-between py-2 border-b border-gray-100 gap-2">
                  ...
                  <span className="font-semibold text-[#01193B] text-right max-w-[160px] truncate">
                    {locationText}
                  </span>
                </div>
                ...
                <div className="flex items-center justify-between py-2 border-b border-gray-100 gap-2">
                  <span className="text-[#01193B]/50 flex items-center gap-2">
                    <Users size={16} className="text-[#467B23]" /> Vacancies
                  </span>
                  <span className="font-semibold text-[#01193B] text-right">
                    {job.vacancies || 1}
                  </span>
              ...
              <div className="bg-white border border-[#01193B]/10 p-5 sm:p-6 lg:p-8 shadow-sm rounded-3xl space-y-4">
                ...
                <div className="space-y-3.5">
                  {latestJobs.map((otherJob) => {
                    const otherLocationText = typeof otherJob.location === 'object' && otherJob.location !== null
                      ? otherJob.location.city || ''
                      : otherJob.location;

                    return (
                      <Link
                        key={otherJob._id || otherJob.slug}
                      ...
                      >
                        ...
                        <p className="text-[11px] text-[#01193B]/50 truncate mt-0.5">
                          {otherJob.companyName} • {otherLocationText}
                        </p>
                      </Link>
                    );
                  })}
